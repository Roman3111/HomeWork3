...
$info = [
    [
        'work_name' => 'Студент',
        'work_date' => 'Август 2000 - май 2007',
        'work_descrip' => 'Учился в КГМА ',
    ],
    [
        'work_name' => 'Врач терапевт',
        'work_date' => 'Сентябрь 2007 - декабрь 2021',
        'work_descrip' => 'Я работал в районной поликлинике со всеми возможными пациентами.',
    ],
    [
        'work_name' => 'Врач хирург',
        'work_date' => 'Март 2022 - текущий',
        'work_descrip' => 'Режу на лево и на право',
    ],
];
...
<body class="w3-light-grey">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal" ><iclass="fa fa-calendar fa-fw w3-margin-right">  </i><?phpecho$info[$i]['work_date']?><span
                                                                                                                                      c>
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal" ><iclass="fa fa-calendar fa-fw w3-margin-right"></i>Forever</h6>
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal" ><iclass="fa fa-calendar fa-fw w3-margin-right"></i>2010 - 2013</h6>
  ...
  <!-- Footer -->
  < footerclass="w3-container w3-teal w3-center w3-margin-top">
